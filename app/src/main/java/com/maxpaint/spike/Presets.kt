...
object Presets {
    ...
    private val flip = listOf(
        ...
        Preset("Mercury") { s ->
            ...
            s.flip.pointSize = 5f; s.flip.emitPerSample = 48
        }
    )
